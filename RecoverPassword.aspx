                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorPass" CssClass="text-danger"
                            runat="server" ErrorMessage="Please enter a new password" ControlToValidate="tbNewPass" Visible="False"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="form-group">
                    <asp:Label ID="lblConfPass" runat="server" CssClass="col-md-2 control-label" Text="Confirm Password" Visible="False"></asp:Label>
                    <div class="col-md-3">
                        <asp:TextBox ID="tbConfPass" CssClass="form-control" TextMode="Password" runat="server" Visible="False"></asp:TextBox>
                        <asp:CompareValidator ID="CompareValidatorPass" CssClass="text-danger" runat="server" ErrorMessage="Both passwords must be the same!"
                            ControlToCompare="tbConfPass" ControlToValidate="tbNewPass" Visible="False"></asp:CompareValidator>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-2"></div>
                    <div class="col-md-6">
                        <asp:Button ID="btRecPass" CssClass="btn btn-default" runat="server" Text="Submit" Visible="False" OnClick="btRecPass_Click" />
                    </div>
                </div>
            </div>
        </div>
